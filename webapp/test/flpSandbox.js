		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Design Phase",
									"targetURL": "#zsapui5btpestimator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsapui5btpestimator-display": {
								"semanticObject": "zsapui5btpestimator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsap.ui5.btpestimator",
									"url": sap.ui.require.toUrl("zsap/ui5/btpestimator")
								}
							}
						}
					}
